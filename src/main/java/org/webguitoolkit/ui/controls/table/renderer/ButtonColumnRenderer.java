 ...
 * 
 */
public class ButtonColumnRenderer extends ChildColumnRenderer {
	 ...
	 * @deprecated
	 */
	public ButtonColumnRenderer(final TableColumn col, boolean isImageProperty, final ITableButtonActionListener listener) {
	 ...
	 * @deprecated
	 */
	public ButtonColumnRenderer(final TableColumn col, String imageSource, String tooltip, final ITableButtonActionListener listener) {
	 ...
	 * @deprecated
	 */
	public ButtonColumnRenderer(final TableColumn col, String imageSource, Tooltip tooltip, final ITableButtonActionListener listener) {
	 ...
	 * @deprecated
	 */
	public ButtonColumnRenderer(final TableColumn col, String labelKey, final ITableButtonActionListener listener) {
	 ...
	 * @deprecated
	 */
	public ButtonColumnRenderer(final TableColumn col, String labelKey, final ITableButtonActionListener listener, boolean cancelBubble) {
	 ...
	 * @deprecated
	 */
	private ButtonColumnRenderer(final TableColumn col, String labelKey, String imageSource, String tooltip, boolean cancelBubble,
	 ...
	 * @deprecated
	 */
	private ButtonColumnRenderer(final TableColumn col, String labelKey, String imageSource, Tooltip tooltipAdvanced, String tooltip,
	 ...
	 * @param listener
	 */
	public ButtonColumnRenderer(boolean isImageProperty, final ITableButtonActionListener listener) {
		this(null, null, null, false, listener);
		isStatic = false;
		this.isImageProperty = isImageProperty;
	}

	public ButtonColumnRenderer(boolean isImageProperty, final ITableButtonActionListener listener, boolean cancelBubble) {
		this(null, null, null, cancelBubble, listener);
		isStatic = false;
		this.isImageProperty = isImageProperty;
	}

	public ButtonColumnRenderer(boolean isImageProperty, String titleProperty, final ITableButtonActionListener listener,
			boolean cancelBubble) {
		this(null, null, null, cancelBubble, listener);
	...
	public ButtonColumnRenderer(String imageSource, String tooltip, final ITableButtonActionListener listener) {
		this(null, imageSource, tooltip, false, listener);
	}

	public ButtonColumnRenderer(String imageSource, String tooltip, final ITableButtonActionListener listener, boolean cancelBubble) {
		this(null, imageSource, tooltip, cancelBubble, listener);
	}

	public ButtonColumnRenderer(String imageSource, Tooltip tooltip, final ITableButtonActionListener listener) {
		this(null, imageSource, tooltip, null, false, listener);
	}

	public ButtonColumnRenderer(String labelKey, final ITableButtonActionListener listener) {
		this(labelKey, null, null, false, listener);
	}

	public ButtonColumnRenderer(String labelKey, final ITableButtonActionListener listener, boolean cancelBubble) {
		this(labelKey, null, null, null, cancelBubble, listener);
	}

	public ButtonColumnRenderer(String labelKey, String imageSource, String tooltip, boolean cancelBubble,
			final ITableButtonActionListener listener) {
		this(labelKey, imageSource, null, tooltip, cancelBubble, listener);
	}

	public ButtonColumnRenderer(String labelKey, String imageSource, Tooltip tooltipAdvanced, String tooltip, boolean cancelBubble,
			final ITableButtonActionListener listener) {
		super();
	...
	protected FormControl[] getFormControls() {
		...
		button = new StandardButton() {
			...
			public void loadFrom(Object data) {
				if (!isStatic && tableColumn.getIsDisplayed() ) {
...
//				}
				if (StringUtils.isEmpty(imgSrc)){
					if (isStatic && imageSource != null)
						imgSrc = imageSource;
					else if (!isStatic && isImageProperty)
						imgSrc = "./images/wgt/1.gif";
					else
						imgSrc = src;
				}
				if (StringUtils.isEmpty(text))
					if (isStatic && labelKey != null)
						text = TextService.getString(labelKey);
					else if (!isStatic && !isImageProperty)
						text = "";
					else
						text = label;
				if (isStatic && tooltip != null )
					setTooltip(tooltip);
				else if(isStatic && tooltipAdvanced != null)
					setTooltip(tooltipAdvanced);
				else
